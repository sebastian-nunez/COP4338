...
// Alter the program to use a for loop to print a tax table of annual income, tax rate, and tax to pay. Use starting and ending annual salaries of 40000 and 60000, respectively, and a salary increment of 5000.
// Run the program again and note the results. You should have five rows in the tax table.
// Alter the program to add user prompts and read the starting and ending annual incomes from user input.
// Run the program again using 40000 and 60000, respectively, and the same salary increment of 5000. You should have the same results as before.
// Alter the program to ask the user for the increment to use in addition to the starting and ending annual salaries.
