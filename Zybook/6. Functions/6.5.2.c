...
double CalcEbayFee(double sellPrice) {
    ...
    if (sellPrice <= 50.00) {  // $50.00 or lower
        ...
        feeTotal = feeTotal + (50 * PERC_50_OR_LESS) + ((sellPrice - 50) * PERC_50_TO_1000);
    } else {  // $1000.01 and higher
        feeTotal = feeTotal + (50 * PERC_50_OR_LESS) + ((1000 - 50) * PERC_50_TO_1000) + ((sellPrice - 1000) * PERC_1000_OR_MORE);
    }
