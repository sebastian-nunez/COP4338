// Modify the existing vector's contents, by erasing 200, then inserting 100 and
// 102 in the shown locations. Use Vector ADT's erase() and insert() only.
// Sample output of below program: 100 101 102 103
