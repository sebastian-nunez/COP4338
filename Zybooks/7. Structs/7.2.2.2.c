// Complete the function ConvertToDecadesAndYears to convert totalYears to decades and years. Return decades and years
// using the TimeDecadesYears struct. Ex: 26 years is 2 decades and 6 years.
