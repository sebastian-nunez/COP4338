...
// baseLength, baseWidth, and pyramidHeight, that returns as a double the volume
// of a pyramid with a rectangular base. CalcPyramidVolume() calls the given
// CalcBaseArea() function in the calculation.
